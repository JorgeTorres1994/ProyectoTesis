/*
import 'dart:async';
import 'package:app_web_proyecto_final/inner_screens/DonacionesScreen.dart';
import 'package:app_web_proyecto_final/inner_screens/LoginScreen.dart';
import 'package:app_web_proyecto_final/inner_screens/MapScreen.dart';
import 'package:app_web_proyecto_final/inner_screens/detalle_mangas_usuario.dart';
      ...
      onTap: () {
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) =>
                //DetalleMangasUsuario(mangaId: mangaId, userRating: 0.0),
                DetalleMangasUsuario(mangaId: mangaId),
          ),
        );
