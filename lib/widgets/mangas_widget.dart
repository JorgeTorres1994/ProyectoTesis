/*
import 'package:app_web_proyecto_final/inner_screens/detalle_mangas.dart';
import 'package:app_web_proyecto_final/inner_screens/editar_mangas.dart';
...
class _MangasWidgetState extends State<MangasWidget> {
  ...
  void mostrarMensajeEliminado(String mensaje) {
    ...
    // Muestra el SnackBar en el contexto actual
                  ...
                  IconButton(
                    ...
                    onPressed: () async {
                      ...
                      if (confirmar != null && confirmar) {
                        ...
                        // Muestra un SnackBar indicando que el manga fue eliminado exitosamente
                        mostrarMensajeEliminado('Manga eliminado exitosamente');
                      }
                    },
                  ),
                ],
