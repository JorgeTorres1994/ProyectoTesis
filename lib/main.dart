...
import 'package:app_web_proyecto_final/inner_screens/agregar_manga.dart';
...
import 'package:app_web_proyecto_final/screens/main_screen_usuarios.dart';
...
void main() async {
  ...
  await Firebase.initializeApp(
    // Replace with actual values
    options: const FirebaseOptions(
      apiKey: "AIzaSyDIkT2D_AaCx_pDGp4VASzPWhv-X9ST4HY",
      appId: "1:655295494265:web:0d2e625fddec854aa6bca8",
      messagingSenderId: "655295494265",
      projectId: "proyecto-final-d4144",
      storageBucket: "proyecto-final-d4144.appspot.com",
    ),
  );
